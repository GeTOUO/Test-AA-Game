...
public abstract class ServerStartUp {
	...
	private static void startServer() throws Exception {
		...
		websocketServerConfig.loadParme().loadHandlers(new Class[] {DispatherHandler.class, CusEnCoderHander.class}, null, false).installConfig(webSocketServerBootstrap).start();
